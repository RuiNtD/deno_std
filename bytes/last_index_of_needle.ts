 ...
 *
 * console.assert(lastIndexOfNeedle(source, needle) === 5);
 * console.assert(lastIndexOfNeedle(source, notNeedle) === -1);
 * ```
 *
 * @example Start index
 * ```ts
 ...
 * const needle = new Uint8Array([1, 2]);
 *
 * console.assert(lastIndexOfNeedle(source, needle, 2) === 1);
 * console.assert(lastIndexOfNeedle(source, needle, 6) === 5);
 * ```
